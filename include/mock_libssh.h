...
/* libssh のエラー コード定義 */
    ...
    /* オプション設定 */
    extern int mock_ssh_options_set(const char *, const int, const char *, ssh_session, enum ssh_options_e,
                                    const void *);

    /* 認証 */
    extern int mock_ssh_userauth_password(const char *, const int, const char *, ssh_session, const char *,
                                          const char *);
    ...
    extern int mock_ssh_get_publickey_hash(const char *, const int, const char *, const ssh_key,
                                           enum ssh_publickey_hash_type, unsigned char **, size_t *);
    ...
    extern void mock_ssh_print_hash(const char *, const int, const char *, enum ssh_publickey_hash_type,
    ...
    #define ssh_options_set(session, type, value) \
        mock_ssh_options_set(__FILE__, __LINE__, __func__, session, type, value)

    #define ssh_userauth_password(session, username, password) \
        mock_ssh_userauth_password(__FILE__, __LINE__, __func__, session, username, password)
    #define ssh_userauth_publickey_auto(session, username, passphrase) \
        mock_ssh_userauth_publickey_auto(__FILE__, __LINE__, __func__, session, username, passphrase)
    ...
    #define ssh_channel_request_exec(channel, cmd) \
        mock_ssh_channel_request_exec(__FILE__, __LINE__, __func__, channel, cmd)
    #define ssh_channel_read(channel, dest, count, is_stderr) \
        mock_ssh_channel_read(__FILE__, __LINE__, __func__, channel, dest, count, is_stderr)
    #define ssh_channel_write(channel, data, len) \
        mock_ssh_channel_write(__FILE__, __LINE__, __func__, channel, data, len)
    ...
    #define ssh_get_server_publickey(session, key) \
        mock_ssh_get_server_publickey(__FILE__, __LINE__, __func__, session, key)
    #define ssh_get_publickey_hash(key, type, hash, hlen) \
        mock_ssh_get_publickey_hash(__FILE__, __LINE__, __func__, key, type, hash, hlen)
    ...
    #define ssh_session_update_known_hosts(session) \
        mock_ssh_session_update_known_hosts(__FILE__, __LINE__, __func__, session)
    ...
    /* SFTP ファイル操作 */
    #define sftp_open(sftp, file, accesstype, mode) \
        mock_sftp_open(__FILE__, __LINE__, __func__, sftp, file, accesstype, mode)
...
extern int delegate_real_ssh_options_set(const char *, const int, const char *, ssh_session, enum ssh_options_e,
                                         const void *);
extern int delegate_fake_ssh_options_set(const char *, const int, const char *, ssh_session, enum ssh_options_e,
                                         const void *);

/* delegate 関数宣言 - 認証 */
extern int delegate_real_ssh_userauth_password(const char *, const int, const char *, ssh_session, const char *,
                                               const char *);
extern int delegate_fake_ssh_userauth_password(const char *, const int, const char *, ssh_session, const char *,
                                               const char *);
extern int delegate_real_ssh_userauth_publickey_auto(const char *, const int, const char *, ssh_session, const char *,
                                                     const char *);
...
extern int delegate_real_ssh_get_publickey_hash(const char *, const int, const char *, const ssh_key,
                                                enum ssh_publickey_hash_type, unsigned char **, size_t *);
extern int delegate_fake_ssh_get_publickey_hash(const char *, const int, const char *, const ssh_key,
                                                enum ssh_publickey_hash_type, unsigned char **, size_t *);
...
extern enum ssh_known_hosts_e delegate_real_ssh_session_is_known_server(const char *, const int, const char *,
                                                                        ssh_session);
extern enum ssh_known_hosts_e delegate_fake_ssh_session_is_known_server(const char *, const int, const char *,
                                                                        ssh_session);
...
extern void delegate_real_ssh_print_hash(const char *, const int, const char *, enum ssh_publickey_hash_type,
                                         unsigned char *, size_t);
extern void delegate_fake_ssh_print_hash(const char *, const int, const char *, enum ssh_publickey_hash_type,
                                         unsigned char *, size_t);
...
extern sftp_file delegate_real_sftp_open(const char *, const int, const char *, sftp_session, const char *, int,
                                         mode_t);
extern sftp_file delegate_fake_sftp_open(const char *, const int, const char *, sftp_session, const char *, int,
                                         mode_t);
...
class Mock_libssh
{
  public:
    ...
    /* オプション設定 */
    MOCK_METHOD(int, ssh_options_set,
                (const char *, const int, const char *, ssh_session, enum ssh_options_e, const void *));

    /* 認証 */
    MOCK_METHOD(int, ssh_userauth_password,
    ...
    MOCK_METHOD(int, ssh_get_publickey_hash,
                (const char *, const int, const char *, const ssh_key, enum ssh_publickey_hash_type, unsigned char **,
                 size_t *));
    MOCK_METHOD(void, ssh_key_free, (const char *, const int, const char *, ssh_key));
    MOCK_METHOD(enum ssh_known_hosts_e, ssh_session_is_known_server,
                (const char *, const int, const char *, ssh_session));
    ...
    MOCK_METHOD(void, ssh_print_hash,
                (const char *, const int, const char *, enum ssh_publickey_hash_type, unsigned char *, size_t));
