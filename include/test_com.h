...
#define EXPECT_FILE_NOT_EXISTS(file_path) EXPECT_TRUE(FileNotExists(file_path))

#define EXPECT_FILE_EXISTS(file_path) EXPECT_TRUE(FileExists(file_path))

#define EXPECT_FILE_CONTAINS(file_path, expected_content) EXPECT_TRUE(FileContains(file_path, expected_content))
